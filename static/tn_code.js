...
var tncode = {
    ...
    _send_result: function () {
        ...
        var re = new _ajax();
        re.request('get', tncode._currentUrl() + '/admin/tncode/check/' + tncode._mark_offset + '/0', haddle);
    },
    ...
    _currentUrl: function () {
        return 'http://192.168.1.200:8099';
    ...
    refresh: function () {
        ...
        var img_url = tncode._currentUrl() + "/admin/tncode/make/0?t=" + Math.random();
